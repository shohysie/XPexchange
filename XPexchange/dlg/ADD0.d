...
APPEND ~%dlgname%~
	...
	IF ~~ THEN BEGIN xpselect1
		...
		IF ~NightmareModeOn() !XPLT(Player1,1500000)~ THEN REPLY @61 GOTO abselect1	//一百五十万点。
		IF ~NightmareModeOn() !XPLT(Player1,2250000)~ THEN REPLY @62 GOTO abselect2	//二百二十五万点。
		IF ~NightmareModeOn() !XPLT(Player1,3000000)~ THEN REPLY @63 GOTO abselect3	//三百万点。
		IF ~NightmareModeOn() !XPLT(Player1,3750000)~ THEN REPLY @64 GOTO abselect4	//三百七十五万点。
		IF ~NightmareModeOn() !XPLT(Player1,5000000)~ THEN REPLY @65 GOTO abselect5	//五百万点。
		IF ~NightmareModeOn() !XPLT(Player1,6000000)~ THEN REPLY @66 GOTO abselect6	//六百万点。
		IF ~NightmareModeOn() !XPLT(Player1,7500000)~ THEN REPLY @67 GOTO abselect7	//七百五十万点。
	...
	IF ~~ THEN BEGIN xpselect2
		...
		IF ~NightmareModeOn() !XPLT(Player2,1500000)~ THEN REPLY @61 GOTO abselect1	//一百五十万点。
		IF ~NightmareModeOn() !XPLT(Player2,2250000)~ THEN REPLY @62 GOTO abselect2	//二百二十五万点。
		IF ~NightmareModeOn() !XPLT(Player2,3000000)~ THEN REPLY @63 GOTO abselect3	//三百万点。
		IF ~NightmareModeOn() !XPLT(Player2,3750000)~ THEN REPLY @64 GOTO abselect4	//三百七十五万点。
		IF ~NightmareModeOn() !XPLT(Player2,5000000)~ THEN REPLY @65 GOTO abselect5	//五百万点。
		IF ~NightmareModeOn() !XPLT(Player2,6000000)~ THEN REPLY @66 GOTO abselect6	//六百万点。
		IF ~NightmareModeOn() !XPLT(Player2,7500000)~ THEN REPLY @67 GOTO abselect7	//七百五十万点。
		IF ~~ THEN REPLY @39 GOTO xpcheck0	//我想换一位队员进行交易。
	END
	...
	IF ~~ THEN BEGIN xpselect3
		...
		IF ~NightmareModeOn() !XPLT(Player3,1500000)~ THEN REPLY @61 GOTO abselect1	//一百五十万点。
		IF ~NightmareModeOn() !XPLT(Player3,2250000)~ THEN REPLY @62 GOTO abselect2	//二百二十五万点。
		IF ~NightmareModeOn() !XPLT(Player3,3000000)~ THEN REPLY @63 GOTO abselect3	//三百万点。
		IF ~NightmareModeOn() !XPLT(Player3,3750000)~ THEN REPLY @64 GOTO abselect4	//三百七十五万点。
		IF ~NightmareModeOn() !XPLT(Player3,5000000)~ THEN REPLY @65 GOTO abselect5	//五百万点。
		IF ~NightmareModeOn() !XPLT(Player3,6000000)~ THEN REPLY @66 GOTO abselect6	//六百万点。
		IF ~NightmareModeOn() !XPLT(Player3,7500000)~ THEN REPLY @67 GOTO abselect7	//七百五十万点。
		IF ~~ THEN REPLY @39 GOTO xpcheck0	//我想换一位队员进行交易。
	END
	...
	IF ~~ THEN BEGIN xpselect4
		...
		IF ~NightmareModeOn() !XPLT(Player4,1500000)~ THEN REPLY @61 GOTO abselect1	//一百五十万点。
		IF ~NightmareModeOn() !XPLT(Player4,2250000)~ THEN REPLY @62 GOTO abselect2	//二百二十五万点。
		IF ~NightmareModeOn() !XPLT(Player4,3000000)~ THEN REPLY @63 GOTO abselect3	//三百万点。
		IF ~NightmareModeOn() !XPLT(Player4,3750000)~ THEN REPLY @64 GOTO abselect4	//三百七十五万点。
		IF ~NightmareModeOn() !XPLT(Player4,5000000)~ THEN REPLY @65 GOTO abselect5	//五百万点。
		IF ~NightmareModeOn() !XPLT(Player4,6000000)~ THEN REPLY @66 GOTO abselect6	//六百万点。
		IF ~NightmareModeOn() !XPLT(Player4,7500000)~ THEN REPLY @67 GOTO abselect7	//七百五十万点。
		IF ~~ THEN REPLY @39 GOTO xpcheck0	//我想换一位队员进行交易。
	END
	...
	IF ~~ THEN BEGIN xpselect5
		...
		IF ~NightmareModeOn() !XPLT(Player5,1500000)~ THEN REPLY @61 GOTO abselect1	//一百五十万点。
		IF ~NightmareModeOn() !XPLT(Player5,2250000)~ THEN REPLY @62 GOTO abselect2	//二百二十五万点。
		IF ~NightmareModeOn() !XPLT(Player5,3000000)~ THEN REPLY @63 GOTO abselect3	//三百万点。
		IF ~NightmareModeOn() !XPLT(Player5,3750000)~ THEN REPLY @64 GOTO abselect4	//三百七十五万点。
		IF ~NightmareModeOn() !XPLT(Player5,5000000)~ THEN REPLY @65 GOTO abselect5	//五百万点。
		IF ~NightmareModeOn() !XPLT(Player5,6000000)~ THEN REPLY @66 GOTO abselect6	//六百万点。
		IF ~NightmareModeOn() !XPLT(Player5,7500000)~ THEN REPLY @67 GOTO abselect7	//七百五十万点。
		IF ~~ THEN REPLY @39 GOTO xpcheck0	//我想换一位队员进行交易。
	END
	...
	IF ~~ THEN BEGIN xpselect6
		...
		IF ~NightmareModeOn() !XPLT(Player6,1500000)~ THEN REPLY @61 GOTO abselect1	//一百五十万点。
		IF ~NightmareModeOn() !XPLT(Player6,2250000)~ THEN REPLY @62 GOTO abselect2	//二百二十五万点。
		IF ~NightmareModeOn() !XPLT(Player6,3000000)~ THEN REPLY @63 GOTO abselect3	//三百万点。
		IF ~NightmareModeOn() !XPLT(Player6,3750000)~ THEN REPLY @64 GOTO abselect4	//三百七十五万点。
		IF ~NightmareModeOn() !XPLT(Player6,5000000)~ THEN REPLY @65 GOTO abselect5	//五百万点。
		IF ~NightmareModeOn() !XPLT(Player6,6000000)~ THEN REPLY @66 GOTO abselect6	//六百万点。
		IF ~NightmareModeOn() !XPLT(Player6,7500000)~ THEN REPLY @67 GOTO abselect7	//七百五十万点。
		IF ~~ THEN REPLY @39 GOTO xpcheck0	//我想换一位队员进行交易。
	END
